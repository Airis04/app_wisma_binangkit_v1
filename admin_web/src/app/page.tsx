...
export default function LoginPage() {
  ...
  return (
    <div className="flex h-screen w-full bg-white z-50 relative">
          ...
          <form className="space-y-6" onSubmit={(e) => e.preventDefault()}>
            <div className="space-y-4">
              <div className="space-y-2">
                ...
                <Input id="email" type="email" placeholder="admin@wismabinangkit.com" className="w-full" required />
              </div>

              <div className="space-y-2">
                <label className="text-sm font-medium text-gray-700" htmlFor="password">Kata Sandi</label>
            ...
            <div className="flex items-center space-x-2">
              ...
              <label htmlFor="remember" className="text-sm font-medium leading-none text-gray-600">Ingat Saya</label>
            </div>

            <Button type="submit" className="w-full bg-[#0A2351] hover:bg-[#081b40] text-white flex items-center justify-center py-6 text-base">
              Masuk ke Dasbor
